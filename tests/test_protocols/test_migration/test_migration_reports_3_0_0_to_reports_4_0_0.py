...
from protocols.reports_3_0_0 import FeatureTypes
...
from protocols.reports_4_0_0 import FeatureTypes
...
class TestMigrateReports3To4(TestCase):
    ...
    def test_migrate_reported_somatic_variants(self):
        ...
        old_variants.reportedVariantCancer.reportEvents[0].genomicFeatureCancer.featureType = FeatureTypes.Gene
        ...
        new_variants.reportedVariantCancer.reportEvents[0].genomicFeatureCancer.featureType = FeatureTypes.Gene

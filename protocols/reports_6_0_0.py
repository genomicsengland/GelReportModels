...
"Trial", "fields": [{"name": "studyUrl", "type": "string", "doc": ""}, {"name": "studyIdientifier",
...
"rferenceUrl", "type": "string", "doc": ""}, {"name": "prognosis", "type": ["null", {"type": "enum",
"name": "PrognosisClassification", "symbols": ["altered_prognosis", "favourable_prognosis",
...
{"type": "record", "name": "Therapy", "fields": [{"name": "rferenceUrl", "type": "string", "doc":
""}, {"name": "source", "type": ["null", "string"], "doc": ""}, {"name": "references", "type":
["null", {"type": "array", "items": "string"}], "doc": ""}, {"name": "drugResponse", "type":
["null", {"type": "array", "items": {"type": "record", "name": "DrugResponse", "fields": [{"name":
...
"int"}, {"name": "reference", "type": ["null", "string"]}, {"name": "alternate", "type": ["null",
"string"]}, {"name": "info", "type": ["null", {"type": "map", "values": "string"}]}]}
"""
    schema = avro.schema.Parse(_schemaSource)
    requiredFields = {
        "alternate",
...
["GRCh38", "GRCh37"]}, "doc": ""}, {"name": "breakPoints", "type": ["null", {"type": "array",
"items": {"type": "record", "name": "BreakPoint", "fields": [{"name": "chromosome", "type":
"string"}, {"name": "start", "type": "int"}, {"name": "end", "type": "int"}, {"name": "reference",
...
["null", "ConfidenceInterval"]}]}}, {"name": "rightCoordinates", "type": "Coordinates"}, {"name":
"orientation", "type": {"type": "enum", "name": "Orientation", "symbols": ["start_start",
...
"type": "string", "doc": ""}, {"name": "phenotypes", "type": {"type": "record", "name":
"Phenotypes", "doc": "", "fields": [{"name": "nonStandardPhenotype", "type": ["null", {"type":
"array", "items": "string"}], "doc": ""}, {"name": "standardPhenotypes", "type": ["null", {"type":
"array", "items": {"type": "record", "name": "StandardPhenotype", "doc": "", "fields": [{"name":
"id", "type": "string"}, {"name": "name", "type": ["null", "string"]}, {"name": "namespace", "type":
...
"type": ["null", "string"]}, {"name": "isA", "type": ["null", "string"]}, {"name": "ontology",
"type": {"type": "record", "name": "Ontology", "doc": "", "fields": [{"name": "name", "type":
"string"}, {"name": "version", "type": "string"}]}, "doc": ""}, {"name": "matchScore", "type":
["null", "float"], "doc": ""}]}}], "doc": ""}]}, "doc": ""}, {"name": "variantConsequences", "type":
...
"doc": "", "fields": [{"name": "panelIdentifier", "type": ["null", "string"], "doc": ""}, {"name":
...
"Tier", "doc": "", "symbols": ["NONE", "TIER1", "TIER2", "TIER3", "TIER4", "TIER5"]}], "doc": ""},
{"name": "domain", "type": ["null", {"type": "enum", "name": "Domain", "symbols": ["DOMAIN1",
"DOMAIN2", "DOMAIN3", "DOMAIN4", "NONE"]}], "doc": ""}]}}}, {"name": "variantCalls", "type":
...
"name": "StructuralVariant", "fields": [{"name": "assembly", "type": "Assembly", "doc": ""},
{"name": "variantType", "type": {"type": "enum", "name": "StructuralVariantType", "symbols": ["ins",
"dup", "inv", "amplification", "deletion", "dup_tandem", "del_me", "ins_me"]}, "doc": ""}, {"name":
"coordinates", "type": {"type": "record", "name": "Coordinates", "fields": [{"name": "chromosome",
...
[{"name": "assembly", "type": "Assembly", "doc": ""}, {"name": "breakPoints", "type": ["null",
{"type": "array", "items": {"type": "record", "name": "BreakPoint", "fields": [{"name":
"chromosome", "type": "string"}, {"name": "start", "type": "int"}, {"name": "end", "type": "int"},
{"name": "reference", "type": ["null", "string"]}, {"name": "alternate", "type": ["null",
"string"]}, {"name": "info", "type": ["null", {"type": "map", "values": "string"}]}]}}]}, {"name":
...
"array", "items": "ReportEvent"}}, {"name": "variantCalls", "type": {"type": "array", "items":
"VariantCall"}, "doc": ""}, {"name": "variantAttributes", "type": ["null",
"VariantAttributes"]}]}}], "doc": ""}, {"name": "shortTandemRepeats", "type": ["null", {"type":
"array", "items": {"type": "record", "name": "ShortTandemRepeat", "fields": [{"name": "assembly",
"type": "Assembly", "doc": ""}, {"name": "coordinates", "type": "Coordinates"}, {"name":
"reportEvents", "type": {"type": "array", "items": "ReportEvent"}}, {"name": "variantCalls", "type":
{"type": "array", "items": "VariantCall"}, "doc": ""}, {"name": "variantAttributes", "type":
["null", "VariantAttributes"]}, {"name": "shortTandemRepeatReferenceData", "type": ["null", {"type":
"record", "name": "ShortTandemRepeatReferenceData", "fields": [{"name": "repeatedSequence", "type":
"string"}, {"name": "pathogenic_number_of_repeats_threshold", "type": "int"}, {"name":
"normal_number_of_repeats_threshold", "type": "int"}]}]}]}}], "doc": ""}, {"name":
"genomicInterpretation", "type": "string", "doc": ""}, {"name": "additionalAnalysisPanels", "type":
["null", {"type": "array", "items": {"type": "record", "name": "AdditionalAnalysisPanel", "doc": "",
"fields": [{"name": "specificDisease", "type": "string"}, {"name": "panel", "type":
"GenePanel"}]}}], "doc": ""}, {"name": "references", "type": ["null", {"type": "array", "items":
"string"}], "doc": ""}, {"name": "referenceDatabasesVersions", "type": {"type": "map", "values":
"string"}, "doc": ""}, {"name": "softwareVersions", "type": {"type": "map", "values": "string"},
"doc": ""}]}
"""
    schema = avro.schema.Parse(_schemaSource)
    requiredFields = {
...
[{"name": "rferenceUrl", "type": "string", "doc": ""}, {"name": "prognosis", "type": ["null",
...
{"type": "array", "items": {"type": "record", "name": "Therapy", "fields": [{"name": "rferenceUrl",
...
"symbols": ["NONE", "TIER1", "TIER2", "TIER3", "TIER4", "TIER5"]}], "doc": ""}, {"name": "domain",
"type": ["null", {"type": "enum", "name": "Domain", "symbols": ["DOMAIN1", "DOMAIN2", "DOMAIN3",
"DOMAIN4", "NONE"]}], "doc": ""}]}}, "doc": ""}, {"name": "variantAttributes", "type": ["null",
{"type": "record", "name": "VariantAttributes", "doc": "", "fields": [{"name": "genomicChanges",
"type": ["null", {"type": "array", "items": "string"}], "doc": ""}, {"name": "cdnaChanges", "type":
["null", {"type": "array", "items": "string"}], "doc": ""}, {"name": "proteinChanges", "type":
["null", {"type": "array", "items": "string"}], "doc": ""}, {"name":
"additionalTextualVariantAnnotations", "type": ["null", {"type": "map", "values": "string"}], "doc":
""}, {"name": "references", "type": ["null", {"type": "map", "values": "string"}], "doc": ""},
{"name": "variantIdentifiers", "type": ["null", {"type": "record", "name": "VariantIdentifiers",
"fields": [{"name": "dbSnpId", "type": ["null", "string"], "doc": ""}, {"name": "cosmicIds", "type":
...
"studyUrl", "type": "string", "doc": ""}, {"name": "studyIdientifier", "type": "string", "doc": ""},
...
"studyIdientifier", "type": "string", "doc": ""}, {"name": "startDate", "type": ["null", "string"],
...
"Tier", "doc": "", "symbols": ["NONE", "TIER1", "TIER2", "TIER3", "TIER4", "TIER5"]}], "doc": ""},
{"name": "domain", "type": ["null", {"type": "enum", "name": "Domain", "symbols": ["DOMAIN1",
"DOMAIN2", "DOMAIN3", "DOMAIN4", "NONE"]}], "doc": ""}]}
"""
    schema = avro.schema.Parse(_schemaSource)
    requiredFields = {
        "actions",
...
"GRCh37"]}, "doc": ""}, {"name": "coordinates", "type": {"type": "record", "name": "Coordinates",
"fields": [{"name": "chromosome", "type": "string"}, {"name": "start", "type": "int"}, {"name":
...
{"name": "ihp", "type": ["null", "int"], "doc": ""}, {"name": "recurrentlyReported", "type":
["null", "boolean"], "doc": ""}, {"name": "fdp50", "type": ["null", "float"], "doc": ""}, {"name":
"others", "type": ["null", {"type": "map", "values": "string"}], "doc": ""}]}]}]}
"""
    schema = avro.schema.Parse(_schemaSource)
    requiredFields = {
        "reportEvents",
...
[{"name": "assembly", "type": {"type": "enum", "name": "Assembly", "doc": "", "symbols": ["GRCh38",
"GRCh37"]}, "doc": ""}, {"name": "variantType", "type": {"type": "enum", "name":
...
"Coordinates", "fields": [{"name": "chromosome", "type": "string"}, {"name": "start", "type":
"int"}, {"name": "end", "type": "int"}, {"name": "ciStart", "type": ["null", {"type": "record",
"name": "ConfidenceInterval", "fields": [{"name": "left", "type": "int"}, {"name": "right", "type":
...
"rferenceUrl", "type": "string", "doc": ""}, {"name": "source", "type": ["null", "string"], "doc":
""}, {"name": "references", "type": ["null", {"type": "array", "items": "string"}], "doc": ""},
{"name": "drugResponse", "type": ["null", {"type": "array", "items": {"type": "record", "name":
"DrugResponse", "fields": [{"name": "TreatmentAgent", "type": "string", "doc": ""}, {"name":
"drugResponseClassification", "type": {"type": "enum", "name": "DrugResponseClassification",
"symbols": ["altered_sensitivity", "reduced_sensitivity", "increased_sensitivity",
"altered_resistance", "increased_resistance", "reduced_resistance", "increased_risk_of_toxicity",

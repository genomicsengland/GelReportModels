...
"type": ["null", {"fields": [{"type": "string", "name": "chromosome"}, {"type": "int", "name":
...
"name": "Coordinates"}], "name": "coordinates"}, {"doc": "", "type": "int", "name":
"numberOfCopies"}]}
"""
    schema = avro.schema.parse(_schemaSource)
    requiredFields = {
...
"type": "int", "name": "numberOfChromosomes"}, {"doc": "", "type": {"symbols": ["UNKNOWN", "XX",
"XY", "XO", "XXY", "XXX", "XXYY", "XXXY", "XXXX", "XYY", "OTHER"], "namespace":
"org.gel.models.participant.avro", "type": "enum", "name": "PersonKaryotipicSex", "doc": ""},
"name": "personKaryotipicSex"}, {"doc": "", "type": "string", "name": "participantId"}]}
"""
    schema = avro.schema.parse(_schemaSource)
    requiredFields = {
        "aneuploidies",
...
"coordinates"}, {"doc": "", "type": {"symbols": ["isodisomy", "heterodisomy", "both"], "type":
"enum", "name": "UniparentalDisomyType"}, "name": "uniparentalDisomyType"}], "type": "record",
"name": "UniparentalDisomyFragment"}, "type": "array"}], "name": "uniparentalDisomyFragments"},
{"doc": "", "type": "string", "name": "participantId"}, {"doc": "", "type": ["null", {"fields":
[{"type": ["null", {"items": {"fields": [{"type": "string", "name": "relatedSample"}, {"type":
"float", "name": "ibd0"}, {"type": "float", "name": "ibd1"}, {"type": "float", "name": "ibd2"},
{"type": "float", "name": "pihat"}], "type": "record", "name": "IdentityByDescent"}, "type":
"array"}], "name": "ibds"}], "type": "record", "name": "UniparentalDisomyEvidences"}], "name":

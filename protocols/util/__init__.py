...
from .generate_mock_objects import get_valid_cancer_participant_1_0_4_SNAPSHOT
...
from .generate_mock_objects import get_valid_cancer_interpretation_request_4_2_0_SNAPSHOT

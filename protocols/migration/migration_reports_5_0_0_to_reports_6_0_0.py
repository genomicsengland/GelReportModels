...
class MigrateReports500To600(BaseMigration):
    ...
    def migrate_interpreted_genome_rd(self, old_instance):
        ...
        new_instance.variants = self.migrate_variants(old_variants=old_instance.variants)
    ...
    def migrate_variant(self, old_variant):
        ...
        new_variant.reportEvents = self.migrate_report_events(report_events=old_variant.reportEvents)
    ...
    def migrate_report_events(self, report_events):
        return [self.migrate_report_event(report_event=report_event) for report_event in report_events]
    ...
    def migrate_report_event(self, report_event):
        ...
        new_report_event.genePanel = self.migrate_gene_panel(gene_panel=report_event.genePanel)
    ...
    def migrate_gene_panel(self, gene_panel):

...
class MigrateReports3ToParticipant1(object):
    ...
    def migrate_tumor_sample(self, old_cancer_sample):
        ...
        new_tumour_sample.TNMStageVersion = old_cancer_sample.tmnStageGrouping
    ...
    def migrate_germline_sample(self, old_cancer_sample):
        ...
        new_germline_sample.preparationMethod = old_cancer_sample.preservationMethod
    ...
    def migrate_sex(self, old_sex):
        sex_map = {
            self.old_model.Sex.F: self.new_model.Sex.FEMALE,
            self.old_model.Sex.M: self.new_model.Sex.MALE,
        }

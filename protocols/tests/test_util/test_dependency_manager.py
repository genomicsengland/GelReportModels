...
class TestDependencyManager(TestCase):
    ...
    def testDependencyManager(self):
        ...
        assert latest_dependencies["org.gel.models.report.avro"] == protocols.reports_4_0_0
        ...
        assert dependencies_400["org.gel.models.report.avro"] != protocols.reports_3_0_0
